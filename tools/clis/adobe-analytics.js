...
/**
 * adobe-analytics CLI
 * Usage: adobe-analytics <resource> <action> [--flag value] [--data '{"k":"v"}']
 */

const TOOL_NAME = 'adobe-analytics';
const API_ENV = 'ADOBE_ANALYTICS_API_KEY';
const BASE_ENV = 'ADOBE_ANALYTICS_BASE_URL';
